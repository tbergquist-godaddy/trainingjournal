...
export default function JournalEntriesList({ journalEntriesPromise }: Props) {
  ...
  if (journalEntries.length === 0) {
    return <Typography type="subtle">No journal entries found for this exercise yet.</Typography>;
  }
